...
const Footer = () => {
    return (
        ...
        <div className="legal">DealBy is a product of <a href="https://bizmarketing.us/" target="_blank" rel="noopener noreferrer" >Bizmarketing.us L.L.C</a></div>
        <div className="legal"> All rights reserved. © 2018 </div>
      </div>
    );
};
